...
var ProductsController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    result = this.productsService.getProducts();
                    console.log(result);
                    return [2 /*return*/, { ok: true, result: result }];
                }
                catch (err) {
                    return [2 /*return*/, { ok: false, row: err.message }];
                }
                return [2 /*return*/];
            });
        });
    ...
    __decorate([
        (0, swagger_1.ApiOkResponse)({ type: products_entity_1.Products, isArray: true }),
        (0, swagger_1.ApiQuery)({ name: 'Products', required: false }),
        (0, swagger_1.ApiCreatedResponse)({ type: products_entity_1.Products }),
        (0, common_1.Get)()
