...
var ProductsRepository = /** @class */ (function (_super) {
    ...
    function ProductsRepository(dataSource) {
        var _this = _super.call(this, products_entity_1.Products, dataSource.createEntityManager()) || this;
        _this.dataSource = dataSource;
        /* 댓글 업로드 퀘스트 수행 */
        _this.logger = new common_1.Logger('ProductsRepository');
        return _this;
    }
    // getProducts
    ...
    ProductsRepository.prototype.getProductsByType = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    this.logger.verbose('repository');
